...
tellFortune('Singer', 'New Yourk', 'John', '4');
tellFortune('Teacher', 'Paris', 'Mark', '1');
tellFortune('Stewardess', 'Dubai', 'Stefan', '3');
tellFortune('Programmer', 'Vienna', 'Ivan', '2');
...
function calculateSupply (age, amountPerDay) {
    var maxAge = 85;
    var restOfTheLife = (amountPerDay * 365) * (maxAge - age);
    console.log('You will need ' + restOfTheLife + ' chips to last you until the ripe old age of ' + age + '.');
} 
...
function celsiusToFahrenheit (celsius) {
    ...
    console.log(celsius + '°C is ' + celsToFahr + '°F')
}
...
function fahrenheitToCelsius(fahrenheit) {
    ...
    console.log(fahrenheit + '°F is ' + fahrToCels + '°C');
  }
